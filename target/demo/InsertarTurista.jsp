...
<head>
    <meta charset="UTF-8">
    <title>Insertar en Tabla Turistas</title>
    <style>
        /* Estilos generales */
        body {
            ...
            margin: 0;
            padding: 0;
            background: url('images/image8.jpg') no-repeat center center fixed; /* Imagen de fondo */
...
<body>
    <div class="container">
        <h2>Insertar Nuevo Turista</h2>
        <form action="InsertarTurista.jsp" method="post">
        ...
        <%
            ...
            if (request.getMethod().equalsIgnoreCase("POST")) {
                ...
                try {
                    ...
                    stmt = conn.prepareCall("{CALL InsertarTurista(?, ?, ?, ?, ?, ?)}");
